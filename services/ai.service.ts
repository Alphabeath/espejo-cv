...
function buildInterviewFeedbackPrompt({
	...
	return [
		...
		"",
		"Devuelve:",
		"- summary: resumen general del desempeño en 2-3 oraciones, pero concreto y específico, evitando generalizaciones vagas",
		"- strengths: de 2 a 4 fortalezas detectadas, cada una con label corto y descripción, sé específico en qué debe mejorar el candidato, no caigas en generalizaciones",
		"- gaps: de 1 a 4 brechas o áreas de mejora, cada una con label y descripción, sé específico en qué debilidades tiene el candidato, no caigas en generalizaciones",
		"- recommendations: de 2 a 4 recomendaciones accionables, cada una con label y descripción, sé específico en qué recomendaciones harás, no caigas en generalizaciones",
		"- turnScores: una evaluación por cada pregunta respondida con turnIndex (empezando en 0), score 0–100 y feedback breve,pero conciso para mejorar esa respuesta en particular, no caigas en generalizaciones, sé específico en qué debe mejorar el candidato para esa pregunta en particular",
		"",
